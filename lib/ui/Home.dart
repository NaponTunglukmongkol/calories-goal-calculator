              ...
              body: Container(
                  ...
                  child: Padding(
                      ...
                      child: new StaggeredGridView.count(
                        ...
                        children: <Widget>[
                          // const Tile1(String target),
                          Tile1(Colors.white, Icons.wifi,
                              snapshot.data['username'], snapshot.data['bmr']),
                          Tile2(user, snapshot.data['bmr']),
                          Tile3(user, Colors.white, Icons.map),
                        ],
                        mainAxisSpacing: 0.0,
...
class Tile1 extends StatelessWidget {
  Tile1(this.backgroundColor, this.iconData, this.username, this.bmr);
  final Color backgroundColor;
  final IconData iconData;
  final String username, bmr;
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Text("Want $bmr cal per Day",
